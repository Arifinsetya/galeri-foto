...
<div class="container">
    <div class="row">
        <div class="col-md-4">
            <div class="card-mt-2">
              <div class="card-header fs-3">Tambah Foto</div>
              <hr>
              <div class="card-body">
...
<!-- 
  bagian dari halaman admin yang memungkinkan pengguna untuk menambah, mengedit, dan menghapus data foto. Berikut adalah penjelasan singkatnya:
...
3. Form Tambah Foto: Bagian ini menampilkan form untuk menambah data foto. Pengguna dapat memasukkan judul foto, deskripsi, memilih album tempat foto tersebut akan disimpan, dan mengunggah file foto.
4. Tampilan Data Foto: Di bagian ini, data foto yang telah disimpan ditampilkan dalam bentuk tabel. Setiap baris tabel menampilkan informasi foto beserta tombol untuk menghapus dan mengedit data foto.
5. Modal Hapus dan Edit: Tombol "Hapus" dan "Edit" masing-masing memunculkan modal yang meminta konfirmasi sebelum menghapus dan memungkinkan pengguna untuk mengedit informasi foto.
